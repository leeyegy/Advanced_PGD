...
#
parser.add_argument("--attack_method",default="PGD",choices=["PGD","FGSM"],type=str)
...
adversary = APGD(model, epsilon=args.epsilon,PGD_step_size=args.step_size,
                     ...
                     random_start=args.random_start,factor=args.factor) if args.attack_method == "PGD" else GradientSignAttack(
